            ...
            preferenceItems = buildList {
                ...
                add(
                    Preference.PreferenceItem.SwitchPreference(
                        ...
                        subtitle = "Redacts manga, chapter, and extension names from Android notifications " +
                ...
                add(
                    Preference.PreferenceItem.InfoPreference(
                        "${stringResource(
                            MR.strings.secure_screen_summary,
                        )}. This does not change Suwayomi server access or stored data.",
                    ),
                )
            },
        )
